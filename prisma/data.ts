export const resources = [
  ...
  },
  {
    ...
    description:
      '2D image to 3D model. Automatically convert 2D to 3D online\n with AI.'
  },
  {
    name: 'Kinetix',
    category: '3D',
  ...
  },
  {
    ...
    description:
      'Magical AI tools. Create endless original images, modify\n existing ones, and more.'
  },
  {
    name: 'DiffusionBee',
    category: 'Art',
    ...
    description:
      'The easiest way to generate AI art on your computer with\n Stable Diffusion.'
  },
  {
    name: 'Civitai',
    category: 'Art',
    ...
    description:
      'community! Free to use, open source, and continually\n improving.'
  },
  {
    name: 'Lexica',
    category: 'Art',
  ...
  },
  {
    ...
    description:
      'The only AI that creates a DaVinci-styled portrait from your\n photo.'
  },
  {
    name: 'ArtHub',
    category: 'Art',
  ...
  },
  {
    ...
    description:
      'Create a beautiful gallery for your AI art without leaving\n Twitter.'
  },
  {
    name: 'PicSo',
    category: 'Art',
    url: 'https://picso.ai',
    description:
      'Text to AI art maker. Turn your words into incredible and\n high-quality artwork.'
  },
  {
    name: 'Daft Art',
    category: 'Art',
    ...
    description:
      "AI album art generator. Create the album cover you've always\n dreamed of!"
  },
  {
    name: 'Clipdrop',
    category: 'Art',
  ...
  },
  {
    ...
    description:
      'Stop wasting hours editing your podcast. Cleanvoice is an artificial intelligence which removes filler sounds, stuttering and mouth sounds from your podcast or audio recording.'
  },
  {
    name: 'Audio Strip',
    category: 'Audio Editing',
  ...
  },
  {
    ...
    description:
      'Create a photorealistic avatar that you can use on every\n video platform.'
  },
  {
    name: 'Arti.pics',
    category: 'Avatars',
  ...
  },
  {
    ...
    description:
      'Create AI photos of yourself. Generate 30 photos of yourself\n in our best artistic styles.'
  },
  {
    name: 'Avatar AI',
    category: 'Avatars',
  ...
  },
  {
    name: 'Clippy AI',
    category: 'Code Assistant',
    url: 'https://marketplace.visualstudio. com/items?itemName=clippy-ai',
    description:
  ...
  },
  {
    ...
    url: 'https://veg3.ai',
    description:
      "Join the beta test for the world's first vegan artificial\n intelligence marketing assistant."
  },
  {
    name: 'Daydrm.ai',
    category: 'Copywriting',
  ...
  },
  {
    ...
    description:
      'Your virtual content assistant that helps you generate quality\n content within seconds.'
  },
  {
    name: 'unbounce',
    category: 'Copywriting',
  ...
  },
  {
    ...
    description:
      'Get your copywriting done faster and easier with 🤖 AI tools. You can also use our AI avatar generator to generate avators. Easy-Peasy.AI believes that everyone has a story to tell. With our AI copywriting tools, we help you tell your story in the most engaging way possible.'
  },
  {
    name: 'Simplified',
    category: 'Copywriting',
  ...
  },
  {
    ...
    url: 'https://lek.ai/',
    description:
      "Lek is an AI copywriting tool. It's the fastest and easiest way to create content and copy. Lek AI helps you write anything for everything."
  },
  {
    name: 'Copysmith',
    category: 'Copywriting',
  ...
  },
  {
    ...
    description:
      'Creaitor helps you write content in a more powerful,\n emotionally expressive way.'
  },
  {
    name: 'Adcreative.ai',
    category: 'Copywriting',
  ...
  },
  {
    ...
    url: 'https://texti.app',
    description:
      'AI that lives in your browser! It will cooperate with you to\n boost your content quality!'
  },
  {
    name: 'Ocoya',
    category: 'Copywriting',
  ...
  },
  {
    ...
    url: 'https://poly.ai/',
    description:
      'Superhuman Voice Assistants. Answer every call immediately,\n 24/7. No agents needed.'
  },
  {
    name: 'Kore.ai',
    category: 'Customer Support',
  ...
  },
  {
    ...
    description:
      'Automate your qualitative data analysis without\n compromising quality.'
  },
  {
    name: 'Vee',
    category: 'Customer Support',
  ...
  },
  {
    ...
    description:
      'Quickchat automates processes such as sales, customer\n support, onboarding or online booking.'
  },
  {
    name: 'Forethought',
    category: 'Customer Support',
  ...
  },
  {
    ...
    url: 'https://ebi.ai',
    description:
      'Reduce call volumes and improve customer experiences with\n an AI assistant.'
  },
  {
    name: 'Harvey',
    category: 'Customer Support',
  ...
  },
  {
    ...
    url: 'https://maya.ai',
    description:
      'Everyone wins with AI-driven personalization: customers,\n banks, and merchants.'
  },
  {
    name: 'Tiledesk',
    category: 'Customer Support',
  ...
  },
  {
    ...
    description:
      'Create personas automatically for your business and for your\n competitor businesses'
  },
  {
    name: 'Kaizan',
    category: 'Customer Support',
    url: 'https://kaizan.ai/',
    description:
      'Kaizan is a Client Intelligence Platform for Client Success\n teams to retain and grow revenue'
  },
  {
    name: 'Echowin',
    category: 'Customer Support',
  ...
  },
  {
    ...
    description:
      'Moonbeam Exchange is a data science platform that leverages over 100 data sources to provide intelligence and insight to the entire innovation ecosystem.'
  },
  {
    name: 'Shumai (Meta)',
    category: 'Developer Tools',
  ...
  },
  {
    ...
    description:
      'Serverless GPU inference for ML models Pay-per-millisecond\n API to run ML in production.'
  },
  {
    name: 'Nuclia',
    category: 'Developer Tools',
    ...
    description:
      'Nuclia automatically indexes your unstructured data from any internal and external source, providing optimized search results. It can handle video and audio transcription, image content extraction, and document parsing.'
  },
  {
  ...
  },
  {
    ...
    url: 'https://gpux.ai',
    description:
      'GPU Everything. Run anything Dockerized. Run autoscale\n Inference. Save costs 50-90%.'
  },
  {
    name: 'RTutor',
    category: 'Developer Tools',
  ...
  },
  {
    ...
    description:
      'Enter your Notes and Yip will generate questions\n automatically from them.'
  },
  {
    name: 'MateAI',
  ...
  },
  {
    ...
    description:
      'Ellie learns from your writing style and crafts replies as if they\n were written by you.'
  },
  {
    name: 'Ipso AI',
    category: 'Email Assistant',
  ...
  },
  {
    ...
    url: 'https://warmer.ai',
    description:
      'Sky rocket your cold emails with unique personalizations\n generated by AI.'
  },
  {
    name: 'Robin',
    category: 'Email Assistant',
  ...
  },
  {
    ...
    description:
      'Alethea AI is working towards enabling the creation of\n interactive and intelligent NFTs (iNFTs).'
  },
  {
    name: 'Ask My Book',
    category: 'Experiments',
  ...
  },
  {
    ...
    description:
      'A fun app that converts movie names to their corresponding\n emojis!'
  },
  {
    name: 'Santa AI',
    category: 'Fun Tools',
  ...
  },
  {
    ...
    description:
      'Turn your writing into a joke at the click of your hand. Make\n people smile.'
  },
  {
    name: 'Hello History',
    category: 'Fun Tools',
  ...
  },
  {
    ...
    url: 'https://chai.ml',
    description:
      'Mobile app that allows you to build and deploy an AI chatbot\n to thousands of users. Chat with AI.'
  },
  {
    name: 'AIDungeon',
    category: 'Gaming',
    ...
    description:
      'Play and create AI-generated adventures with infinite\n possibilities.'
  },
  {
    name: 'AI Careers',
    category: 'Gaming',
    ...
    description:
      'AI Job Search Made Easy. Unlocking the potential of data to\n drive innovation.'
  },
  {
  ...
  },
  {
    ...
    url: 'https://aiduh.com',
    description:
      'Chrome extension that cuts your writing time by 98% with AI-\n powered responses.'
  },
  {
    name: 'Writely',
    category: 'General Writing',
  ...
  },
  {
    ...
    description:
      'ParagraphAI is an AI Writing App that writes clear, concise,\n and error-free content.'
  },
  {
    name: 'DREAM.page',
    category: 'General Writing',
    ...
    description:
      'Write and publish with the magic of AI! Join the waitlist now.'
  },
  {
    name: 'Maester.app',
    category: 'General Writing',
  ...
  },
  {
    ...
    description:
      'The only AI writer that integrates with your Mac. Works\n across applications.'
  },
  {
    name: 'Sudowrite',
    category: 'General Writing',
  ...
  },
  {
    ...
    description:
      'Give the perfect gift! Discover creative gift ideas for anyone\n based on who they are.'
  },
  {
    name: 'Elf Help',
    category: 'Gift Ideas',
  ...
  },
  {
    ...
    description:
      'Colorize Black and White Pictures Automatic, no sign-up, and\n Free!'
  },
  {
    name: 'Visio Studio',
    category: 'Image Editing',
  ...
  },
  {
    ...
    url: 'https://bria.ai',
    description:
      'Integrate Bria’s AI-powered API to automate and scale the\n creation of video and images.'
  },
  {
  ...
  },
  {
    ...
    description:
      'Create Images, Blogs, Ads, Website Headlines all with the\n click of a button.'
  },
  {
  ...
  },
  {
    ...
    description:
      'alpaca is a Photoshop Plugin for to combine AI image\n generation power with human skill.'
  },
  {
  ...
  },
  {
    ...
    description:
      'Creating images with text. Generate text-based images to\n help you think and create.'
  },
  {
    name: 'Stylized',
    category: 'Image Generator',
  ...
  },
  {
    ...
    description:
      'Integration Stable Diffusion in Notion to AI generate images\n with a new slash command.'
  },
  {
    name: 'Enterpix',
    category: 'Image Generator',
  ...
  },
  {
    ...
    description:
      'Detangle gives you AI-generated summaries of your legal\n docs so you can actually understand them.'
  },
  {
    name: 'Activazon',
    category: 'Legal Assistant',
  ...
  },
  {
    ...
    category: 'Life Assistant',
    url: 'https://WriteMeACoverLetter.co m',
    description:
  ...
  },
  {
    ...
    url: 'https://vwo.com',
    description:
      'Turn your visitors into paying customers. Set up your first\n experiment right away.'
  },
  {
    name: 'Durable AI',
    category: 'Low-code/no-code',
  ...
  },
  {
    ...
    description:
      'The easiest way to build AI from text, image, or audio. In\n minutes. No code required.'
  },
  {
    name: 'Build AI',
    category: 'Low-code/no-code',
  ...
  },
  {
    ...
    url: 'https://seek.ai',
    description:
      'The intelligent data layer. Ask your data anything and get\n answers, instantly'
  },
  {
    name: 'Lightning AI',
    category: 'Low-code/no-code',
  ...
  },
  {
    ...
    url: 'https://endel.io',
    description:
      'Personalized soundscapes to help you focus, relax, and sleep.\n Backed by neuroscience.'
  },
  {
    name: 'Harmonai',
    category: 'Music',
  ...
  },
  {
    ...
    description:
      'Open Voice OS showcases the power of Open Source Voice AI for a range of devices. A community powered Linux distribution.'
  },
  {
    name: 'Emergent Drums',
    category: 'Music',
  ...
  },
  {
    ...
    description:
      'Paraphrase Tool uses AI to produce variations of your text in\n more than 100+ languages.'
  },
  {
    name: 'Quillbot\n Paraphraser',
    category: 'Paraphraser',
  ...
  },
  {
    ...
    url: 'https://tavus.io',
    description:
      'Meet Tavus, the programmatic personalized video tool made for top-performing product, marketing, and sales teams that want to transform how they build relationships. Record once and discover the power of Tavus as our AI automatically generates personalized videos for audiences large and small.'
  },
  {
    name: 'Rephrase',
    category: 'Personalized Videos',
  ...
  },
  {
    ...
    description:
      'Collection of High Quality and Open Source Prompts for\n Image generation'
  },
  {
    name: 'Img2prompt',
    category: 'Prompts',
  ...
  },
  {
    ...
    description:
      'Website that aggregates news related to AI and ML in\n Japanese.'
  },
  {
    name: 'FlowGPT',
    category: 'Resources',
  ...
  },
  {
    ...
    url: 'https://regie.ai',
    description:
      'Regie helps sales, marketing, and success teams write\n engaging content faster using AI'
  },
  {
    name: 'Cresta',
    category: 'Sales',
  ...
  },
  {
    ...
    description:
      'Andi is search for the next generation using generative AI. Instead of just links, Andi gives you answers - like talking with a smart friend.'
  },
  {
    name: 'One More AI',
    category: 'Search Engine',
    ...
    description:
      'AI-Generated Stock Images Find thousands of pictures\n generated by Artificial Intelligence.'
  },
  {
    name: 'AnyPod',
    category: 'Search Engine',
  ...
  },
  {
    ...
    description:
      'Build powerful multimodal search into your app. Use our API to easily search your images, video, audio, and more with AI.'
  },
  {
    name: 'Explore AI',
    category: 'Search Engine',
  ...
  },
  {
    ...
    url: 'https://steno.ai',
    description:
      'Your favorite podcasts, fully transcribed Discover, reference,\n and read along as you listen.'
  },
  {
    name: 'Krea',
    category: 'Search Engine',
  ...
  },
  {
    ...
    url: 'https://neeva.com',
    description:
      'NeevaAI provides authentic, real-time AI search. It combines the power of AI with a search stack to give you fast, accurate, and up-to-date results. And, it provides sources where the information was pulled from.'
  },
  {
    name: 'Context',
    category: 'Search Engine',
  ...
  },
  {
    ...
    description:
      'The best Search and Discovery Platform for your business Algolia empowers Builders with Search and Recommendation services to create world-class digital experiences.'
  },
  {
    name: 'You',
    category: 'Search Engine',
  ...
  },
  {
    ...
    description:
      'AI Generated Visuals We make it easy for you to get the exact\n visual you need.'
  },
  {
    name: 'Nyx',
    category: 'Search Engine',
  ...
  },
  {
    ...
    url: 'https://jenni.ai',
    description:
      'You Write, Jenni Completes Supercharge your writing with\n the most advanced AI writing assistant.'
  },
  {
    name: 'Closers Copy',
    category: 'SEO',
  ...
  },
  {
    ...
    url: 'https://typli.ai',
    description:
      'The most intuitive A.I Content tool which combines AI Writing\n and an SEO Assistant.'
  },
  {
    name: 'Eilla AI',
    category: 'SEO',
  ...
  },
  {
    ...
    description:
      'Write perfect SEO-friendly content for blog posts, website\n pages, and articles… with AI.'
  },
  {
    name: 'Katteb',
    category: 'SEO',
    ...
    description:
      'Katteb AI makes it fast & easy to create content for your blog\n and online store.'
  },
  {
    name: 'Thundercontent',
    category: 'SEO',
  ...
  },
  {
    ...
    description:
      'Generate Content & Copy In Seconds with AI Use AI to boost your traffic and save hours of work. Automatically write unique, engaging and high-quality copy or content: from long- form blog posts or landing pages to digital ads in seconds.'
  },
  {
    name: 'ArticleForge',
    category: 'SEO',
  ...
  },
  {
    ...
    description:
      'A unified content repository that repurposes technical\n content better and faster than an agency'
  },
  {
    name: 'Editby',
    category: 'Social Media Assistant',
  ...
  },
  {
    ...
    description:
      'Power your fundraise with just one tool that does it all. Finta is your fundraising copilot. Automating your workflow end to end, so you can get back to growing your business.'
  },
  {
    name: 'Ideabuddy',
    category: 'Startup',
  ...
  },
  {
    ...
    description:
      'Get instant feedback on your pitch deck, so fundraising\n becomes the least of your concerns.'
  },
  {
    name: 'Namewizard.ai',
    category: 'Startup',
  ...
  },
  {
    ...
    description:
      "Subtxt is the only intelligent outliner that works with your\n writer's intuition, not against it."
  },
  {
    name: 'Fabled',
    category: 'Story Teller',
    url: 'https://fabled.ai',
    description:
      'The Ultimate AI Story Generator. Stories created by you, powered by AI. With a single sentence fabled.ai crafts personal illustrated stories, enriched by stunning images. Try for free!'
  },
  {
    name: 'Artflow ai',
    category: 'Story Teller',
  ...
  },
  {
    ...
    description:
      'Create original stories with AI. Tell OnceUponABot your story idea, and the robot will write a story from scratch using AI.'
  },
  {
    name: 'NovelAI',
    category: 'Story Teller',
  ...
  },
  {
    ...
    description:
      'A fun way to learn something new. Generate stories with just\n an one-word prompt.'
  },
  {
    name: 'Summate',
    category: 'Summarizer',
  ...
  },
  {
    ...
    url: 'https://genei.io',
    description:
      'Automatically summarise background reading and produce\n blogs, articles, and reports faster.'
  },
  {
    name: 'Otter AI',
    category: 'Summarizer',
  ...
  },
  {
    ...
    description:
      'Summarize any text on the internet in one click. Supercharge your productivity. Get to the point in a fraction of the time.'
  },
  {
    name: 'Wellsaidlabs',
  ...
  },
  {
    ...
    description:
      'Turn your reads into podcasts. Listen to any article, PDF,\n email, etc in your podcast app.'
  },
  {
    name: 'Whisper',
    category: 'Text To Speech',
  ...
  },
  {
    ...
    description:
      'Too lazy to read an article? no problem, listen to it! Convert\n Articles To Audio'
  },
  {
    name: 'Convai',
    category: 'Text To Speech',
  ...
  },
  {
    ...
    description:
      'Get your text spoken by celebrities like Gwyneth Paltrow and Snoop Dogg. Text to speech for Chrome, iOS, Android, & Mac.'
  },
  {
    name: 'Eleven Labs',
    category: 'Text To Speech',
  ...
  },
  {
    ...
    description:
      'AI assistant for your meetings Record, transcribe, and search\n across your voice conversations.'
  },
  {
    name: 'Whisper Memos',
    category: 'Transcriber',
  ...
  },
  {
    ...
    description:
      'Discover advanced video editing capabilities to take your\n creations to the next level.'
  },
  {
    name: 'Unscreen.com',
    category: 'Video Editing',
  ...
  },
  {
    ...
    url: 'https://replicate.com',
    description:
      'FILM - Frame Interpolation for Large Scene Motion. Frames are generated between two existing images (Interpolation) in attempt to create a animation.'
  },
  {
    name: 'Astria',
    category: 'Video Generator',
    url: 'https://astria.ai',
    description:
      'Tailor-made AI image generation. Start creating your unique\n images.'
  },
  {
    name: 'Waymark',
    category: 'Video Generator',
  ...
  },
  {
    ...
    url: 'https://steve.ai',
    description:
      "Steve AI is an AI video maker for social media and content marketers for creating Live and Animated videos. With Steve AI's assistance, you can turn blog posts, script, or text content into bite-sized videos for social media. It's features include Creative AI, Search AI and Fully Automated Solution."
  },
  {
    name: 'InVideo',
    category: 'Video Generator',
  ...
  },
  {
    ...
    url: 'https://wowto.ai',
    description:
      'Create how-to videos and host an engaging video knowledge base in minutes. Build Video Knowledge Base.'
  },
  {
    name: 'Colossyan',
    category: 'Video Generator',
  ...
  },
  {
    ...
    description:
      'At Wonder Dynamics, we combine AI technology with first- class storytelling.'
  },
  {
    name: 'Creative Reality Studio (D-ID)',
    category: 'Video Generator',
    url: 'https://studio.d-id.com',
    description:
      'The world’s first platform to combine GPT-3, Stable Diffusion, and D-ID’s unique face animation technology. Our generative AI will turn your vision into a talking avatar within seconds.'
  },
  {
    name: 'LiveReacting AI',
    category: 'Video Generator',
  ...
  },
  {
    ...
    url: 'https://vidiq.com',
    description:
      'Boost your YouTube views with AI. Get free insights and\n guidance to keep your channel growing.'
  },
  {
    name: 'Raw Shorts',
  ...
  },
  {
    ...
    url: 'https://muse.ai/',
    description:
      'A software that helps people create videos, edit them, and many more features without any skill for video editing'
  },
  {
    name: 'Wideo',
    category: 'Video Editing',
    url: 'https://wideo.co/',
    description:
      'Online video creation platform that enables users to create,\n edit, and share online videos'
  },
  {
    name: 'Toonly',
  ...
  {
    name: 'Synthesy Io',
    category: 'Text to Voice Over and Video',
    url: 'https://synthesys.io/',
    description:
      'Developing algorithms for text to voiceover and videos for commercial use'
  },
  {
    name: 'LiveReacting AI',
    category: 'Video Generator',
